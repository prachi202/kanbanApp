...
function columnCount() {
    const data = read();
    const todo = document.querySelector(".cmp-kanbanApp__container__kanban__taskbox__title--todo");
    todo.textContent = data[0].tasks.length;
    const pending = document.querySelector(".cmp-kanbanApp__container__kanban__taskbox__title--pending");
    pending.textContent = data[1].tasks.length;
    const completed =  document.querySelector(".cmp-kanbanApp__container__kanban__taskbox__title--completed");    
